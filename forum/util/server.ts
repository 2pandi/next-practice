...
export const response401 = (res: NextApiResponse) =>
  res.status(401).json({ message: ERROR_MESSAGE.UNAUTHORIZED_ACCESS });

export const response405 = (res: NextApiResponse, ...allowedMethod: string[]) =>
  res
